    ...
    <div className="space-y-4">
      ...
      {protocols.length === 0 ? (
        ...
        <div className={`${cardClass} p-0 overflow-hidden`}>
          <table className="w-full text-sm"><thead className="bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-800"><tr>{[t("API Path", "API 路径"), t("Protocol", "协议"), t("Config", "配置"), t("Status", "状态"), t("Created", "创建时间"), ...(canWrite ? [t("Actions", "操作")] : [])].map(h => th(h))}</tr></thead>
