        ...
        <div className="space-y-6">
          <div>
            ...
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefEmailRuleChanges} onChange={(e) => cb("email.rule_changes", e.target.checked)} />
              <span className="text-sm text-gray-700 dark:text-gray-300">{t("Rule change alerts", "规则变更提醒")}</span>
            </label>
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefEmailSecurity} onChange={(e) => cb("email.security_alerts", e.target.checked)} />
              <span className="text-sm text-gray-700 dark:text-gray-300">{t("Security alerts (API keys, users, passwords)", "安全告警（API密钥、用户、密码）")}</span>
            </label>
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefEmailProductUpdates} onChange={(e) => cb("email.product_updates", e.target.checked)} />
          ...
          <div>
            ...
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefInAppApprovals} onChange={(e) => cb("in_app.approvals", e.target.checked)} />
              <span className="text-sm text-gray-700 dark:text-gray-300">{t("Approval requests", "审批请求")}</span>
            </label>
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefInAppProductUpdates} onChange={(e) => cb("in_app.product_updates", e.target.checked)} />
              <span className="text-sm text-gray-700 dark:text-gray-300">{t("Product & subscription changes", "产品与订阅变更")}</span>
            </label>
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefInAppInfrastructure} onChange={(e) => cb("in_app.infrastructure", e.target.checked)} />
            ...
            <label className="flex items-center gap-3 py-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded accent-blue-600 cursor-pointer" checked={prefInAppAudit} onChange={(e) => cb("in_app.audit", e.target.checked)} />
