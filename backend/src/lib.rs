...
pub async fn run() -> anyhow::Result<()> {
    ...
    let api_router = Router::new()
        ...
        .route("/api/v1/approvals/my-pending", get(my_pending_approvals))
        .route("/api/v1/approvals/my-requests", get(my_approval_requests))
        ...
        .route("/api/v1/llm/providers/:id", get(get_llm_provider).put(update_llm_provider).delete(delete_llm_provider))
        .route("/api/v1/llm/prompt-templates", post(create_prompt_template).get(list_prompt_templates))
        .route("/api/v1/llm/prompt-templates/:id", get(get_prompt_template).put(update_prompt_template).delete(delete_prompt_template))
